...
export class BentoItemWhoiamComponent {
  ...
  protected readonly WHOIAM_TITLE = computed(() => this.i18nService.getConstant('userConst')?.ABOUT_USER?.whoIamTitle || ABOUT_USER.whoIamTitle);
  protected readonly DESCRIPTION = computed(() => this.i18nService.getConstant('userConst')?.ABOUT_USER?.whoIam || ABOUT_USER.whoIam);
}
